; ModuleID = 'strcpy-test.c'
source_filename = "strcpy-test.c"
...
define i32 @main() #0 {
  ...
  %8 = call i8* @strcpy(i8* %6, i8* %7) #3
  %9 = getelementptr inbounds [10 x i8], [10 x i8]* %4, i32 0, i32 0
  %10 = call i8* @strcpy(i8* %9, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0)) #3
  ret i32 0
}
