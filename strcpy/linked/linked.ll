...
define i32 @main() #0 {
  ...
  %8 = call i8* @mystrcpy(i8* %6, i8* %7)
  %9 = getelementptr inbounds [10 x i8], [10 x i8]* %4, i32 0, i32 0
  %10 = call i8* @mystrcpy(i8* %9, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0))
  ret i32 0
}
...
define i8* @mystrcpy(i8* noalias, i8* noalias) #0 {
  ...
  %7 = call i8* @__stpcpy(i8* %5, i8* %6) #3
  %8 = load i8*, i8** %3, align 8
  ret i8* %8
}

; Function Attrs: nounwind
declare i8* @__stpcpy(i8*, i8*) #2
