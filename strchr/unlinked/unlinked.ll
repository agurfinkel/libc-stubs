; ModuleID = 'strchr-test.c'
source_filename = "strchr-test.c"
...
define i32 @main() #0 {
  ...
  %6 = call i8* @strchr(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @main.vowel, i32 0, i32 0), i32 105) #3
  store i8* %6, i8** %4, align 8
  %7 = call i8* @strchr(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @main.vowel, i32 0, i32 0), i32 98) #3
